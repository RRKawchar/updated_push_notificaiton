...
class PushNotificationService{
  ...
  static sendNotification()async {
    ...
    print("Get Access Token for bearer token: $accessToken");
    String endpointCloudMessaging = "https://fcm.googleapis.com/v1/projects/push-notification-check-537d4/messages:send";

    final Map<String, dynamic> message = {
      "message": {
        "token": "eNqoiWXTQUuYPaq2Gt_yV1:APA91bEuPITbVvFhupWYP_Pe-PwF4I_6Ztzc4d106kS4bhY7jJmwcyyHJYjgbmzbdbw5OcTc9QfYOT6vNqvVOpJVnr7zFAhHlihVh8KOzCIfCWwOM9KOpYT1M8aEOmwoq3jJiv9spWEz",
        "notification": {
